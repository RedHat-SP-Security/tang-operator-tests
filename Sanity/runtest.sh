...
TO_LEGACY_POD_RUNNING=180 #seconds
TO_DAST_POD_COMPLETED=300 #seconds (DAST lasts around 120 seconds)
TO_POD_STOP=10 #seconds
TO_POD_TERMINATE=180 #seconds
TO_POD_CONTROLLER_TERMINATE=240 #seconds (for controller to end must wait longer)
TO_SERVICE_START=180 #seconds
TO_SERVICE_STOP=180 #seconds
TO_EXTERNAL_IP=180 #seconds
TO_WGET_CONNECTION=15 #seconds
TO_ALL_POD_CONTROLLER_TERMINATE=180 #seconds
TO_KEY_ROTATION=5 #seconds
TO_ACTIVE_KEYS=120 #seconds
TO_HIDDEN_KEYS=120 #seconds
TO_SERVICE_UP=240 #seconds
ADV_PATH="adv"
